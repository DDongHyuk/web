...
<body>
   ...
   <article class="container">
            ...
            <div class="col-sm-6 col-md-offset-3">
                <form:form modelAttribute ="userVO" name="userVO" action="/user/action" method="post" role="form" id="usercheck" name="member">
                <input type="hidden" name = "node" id = "mode" value="${mode }"/>
                 
                    <div class="form-group">
                        <label for="id">아이디</label>
                        <input type="text" class="form-control" id="id" name="id" value = "${userVO.id}" placeholder="ID">
                        <div class="eheck_font" id="id_check"></div>
                    </div>
                    
                    <div class="form-group">
                        <label for="pw">비밀번호</label>
                        <input type="password" class="form-control" id="pw" name="pw" value = "${userVO.pw}" placeholder="PASSWORD">
                        <div class="eheck_font" id="pw_check"></div>
                    </div>
                    <div class="form-group">
                        <label for="pw2">비밀번호 확인</label>
                        <input type="password" class="form-control" id="pw" name="pw" value = "${userVO.pw}" placeholder="Confirm Password">
                          <div class="eheck_font" id="pw2_check"></div>
                    </div>
                    
                       <div class="form-group">
                        <label for="mem_name">이름</label>
                        <input type="text" class="form-control" id="name" name="name" value = "${userVO.name}" placeholder="Name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value = "${userVO.email}" placeholder="E-mail">
...
<div class="form-group">
  ...
  <div class="form-group text-center">
       <button type="submit" class="btn btn-primary" onclick="board/login">회원가입</button> 
  </div>
                </form:form>
            </div>
        </article>
